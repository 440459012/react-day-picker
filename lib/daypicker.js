...
DayPicker.defaultProps = {
  ...
  captionElement: _react2.default.createElement(_Caption2.default, { classNames: _classNames2.default, hideYear: undefined.props.hideYear })
};
...
DayPicker.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  hideYear: _propTypes2.default.bool,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { onClick: onClick },
          months ? months[date.getMonth()] + ' ' + (hideYear ? '' : date.getFullYear()) : localeUtils.formatMonthTitle(date, locale)
        )
      );
    }
  }]);
...
var Weekday = function (_PureComponent) {
